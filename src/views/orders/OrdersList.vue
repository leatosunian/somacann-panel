            ...
            <div class="header mt-md-5">
              <div class="header-body">
                <div class="row align-items-center">
                  <div class="col">
                    <!-- Pretitle -->
                    <h6 class="header-pretitle">Mis Pedidos</h6>
                    <!-- Title -->
                  ...
                  <tbody class="fs-base" v-if="orders.length >= 1">
                    <tr v-for="item in orders">
                      ...
                      <td>
                        <a
                          >#{{
                            item.orderNumber.toString().padStart(6, "000000")
                          }}</a
                        >
                      </td>
                      <td>
  ...
  methods: {
    ...
    getOrders() {
      if (!this.inicio) {
        ...
        axios
          .get(this.$url + "/orders/get/" + this.inicio + "/" + this.hasta, {
            headers: {
    ...
    searchOrders() {
      axios
        .get(this.$url + "/orders/search/" + this.searchFilter, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${this.$token}`,
          },
