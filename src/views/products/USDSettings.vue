              ...
              <div class="header-body">
                <div class="row align-items-center">
                  <div class="col">
                    ...
                    <!-- Title -->
                    <h1 class="header-title">Precios en tienda</h1>
                  </div>
                </div>
                <!-- / .row -->
              </div>
            ...
            <div>
              <div class="row">
                ...
                <div class="col-12 col-md-6">
                  ...
                  >
                    <img
                      src="@/assets/clock-rotate-left-solid.svg"
                      style="width: 11px"
                    />
                    <router-link
                      to="/usdlogs"
...
export default {
  ...
  methods: {
    ...
    getUSDSettings() {
      ...
      axios
        .get(`${this.$url}/config/getusdsettings`, {
          headers: {
    ...
    saveUSDSetting() {
      axios
        .put(`${this.$url}/config/usdsettings`, this.USDData, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${this.$token}`,
          },
