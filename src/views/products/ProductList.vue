              ...
              <div class="header-body">
                <div class="row align-items-center">
                  <div class="col">
                    ...
                    <!-- Title -->
                    <h1 class="header-title">Todos mis productos</h1>
                  </div>
                </div>
                <!-- / .row -->
                <div class="row align-items-center">
              ...
              <div class="row justify-content-center">
                <div class="my-5 col-12 col-md-5 col-xl-4">
                  <div class="text-center">
                    <!-- Preheading -->
                    <h6 class="mb-4 text-uppercase text-muted">404 error</h6>

                    <!-- Heading -->
                    <h1 class="mb-3 display-4">No tienes productos</h1>
                        ...
                        >
                          ...
                          >
                            <div class="row align-items-center">
                              ...
                              <div class="col-auto">
                                <span
                                  ><b>{{ priceConverter(item.price) }}</b></span
                                >
                              </div>
                              <div class="col-auto">
                                <!-- Dropdown -->
                                <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <b-modal
                                      ...
                                      :id="'delete-' + item._id"
                                      title="BootstrapVue"
                                      title-html="<h4 class='card-header-title'><b>Eliminar producto</b></h4>"
                                      @ok="deleteProduct(item._id)"
                                    >
                                      <p class="my-4">
...
export default {
  ...
  methods: {
    getProducts() {
      ...
      axios
        .get(this.$url + "/products/" + this.filter, {
          headers: {
