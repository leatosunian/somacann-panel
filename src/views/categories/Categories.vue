          ...
          <div class="col-12 col-lg-10 col-xl-8">
            ...
            <div class="header mt-md-5">
              <div class="header-body">
                <div class="row align-items-center">
                  <div class="col">
                    <!-- Pretitle -->
                    <h6 class="header-pretitle">Configuraciones</h6>

                    <!-- Title -->
                    <h1 class="header-title">Todos las categorias</h1>
                  </div>
                </div>
                <!-- / .row -->
              </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <ul
                  class="list-group list-group-flush list my-n2"
                ...
                >
                  <li class="list-group-item" v-for="item in allCategories">
                    ...
                    >
                      <div class="col">
                        ...
                        <span style="font-size: 12px"
                          >{{ item.qOfProducts }} Productos</span
                        >
                      </div>
                      ...
                      <div class="col-auto">
                        ...
                        <!-- Button -->
                        <a
                          v-b-modal="`eliminar-${item.category._id}`"
                          class="text-white btn btn-sm btn-danger"
                        >
                          X
                        </a>
                        <b-modal
                          :id="`eliminar-${item.category._id}`"
                          title="BootstrapVue"
                          title-html="<h4 class='card-header-title'><b>Eliminar categoria<b/></h4>"
                          @ok="deleteCategory(item.category._id)"
                        >
                    ...
                    <!-- FORM ADD CATEGORY -->
                    <div
                      class="mt-3 col-12 col-lg-6 col-md-10 hideInput contentGroup"
                      :id="'content-' + item.category._id"
                    >
                      <div class="mb-3 input-group">
                        <input
                          type="text"
                          class="form-control"
                          placeholder="Ingresa la nueva subcategoría"
                      ...
                      <div class="col-12">
                        ...
                        >
                          ...
                          >
                            ...
                            <b-modal
                              :id="`disable-${subItem._id}`"
                              title="BootstrapVue"
                              title-html="<h4 class='card-header-title'><b>Eliminar subcategoria<b/></h4>"
                              @ok="deleteSubcategory(subItem._id)"
                            >
                              <p class="my-4" style="font-size: 16px">
                                Deseas eliminar la subcategoría
                                <b>{{ subItem.name }}</b
                                >?
                              </p>
                            </b-modal>
  ...
  methods: {
    ...
    createNewSubcategory() {
      if (this.newSubcategory) {
        ...
        axios
          .post(
            this.$url + "/subcategories/create",
            { name: this.newSubcategory, category: this.categoryId },
            {
              headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${token}`,
    ...
    deleteCategory(id) {
      const token = localStorage.getItem("token");
      axios
        .delete(this.$url + "/categories/delete/" + id, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
          },
    ...
    deleteSubcategory(id) {
      const token = localStorage.getItem("token");
      axios
        .delete(this.$url + "/subcategories/delete/" + id, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
          },
