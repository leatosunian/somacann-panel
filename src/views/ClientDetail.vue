                      ...
                      <div class="list-group-item">
                        <div class="row align-items-center">
                          ...
                          <div class="col-auto">
                            ...
                            <small
                              class="text-muted"
                              v-if="clientDat.enabled == true"
                            >
                              Habilitado
                            </small>
                            <small
                              class="text-muted"
                              v-if="clientDat.enabled == false"
                            >
                              Deshabilitado
                            </small>
                          </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <router-link
                          ...
                          "
                        >
                          <a style="color: white !important">Datos</a>
                        </router-link>
                      </td>
                    </tr>
                  </tbody>
...
export default {
  ...
  methods: {
    ...
    getClient() {
      ...
      axios
        .get(this.$url + "/clients/" + this.$route.params.id, {
          headers: {
